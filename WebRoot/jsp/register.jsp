...
//                }
//            }
>>>>>>> 061afa1e876919394e5cceab2fc7d803a19e5039
        }
                ...
                <ul class="reg_form" id="reg-ul">
                    <li>
                        ...
                        <div class="inputOuter2">
                            <input type="text" id="username" maxlength="10" name="user.userName"
                                   onBlur="registerExtenceCheck1();"
                                   class="inputstyle2"/>
                        </div>
