...
<div class="article">
    ...
    <div class="content">
            ...
            <s:iterator value="#request.chapterList" id="chapters">
                <s:if test="#pieces.pieceId == #chapters.pieceId">
                    ...
                    <s:if test="#pieces.pieceId != 0">
                        <a href="<s:property value="#chapters.filepath"/>">第<s:property value="#chapters.chapterId"/>章:
                        <s:property value="#chapters.chapterName"/></a>
                    </s:if>
                    <s:else>
                        <a href="<s:property value="#chapters.filepath"/>">序章: <s:property
                            value="#chapters.chapterName"/></a>
                    </s:else>
        ...
        <c:if test="${session.user.position=='2'}">
            ...
            <input type="button" class="btn btn-default" style="margin-right:20px;" onclick="addTeachingPlan()"
                   value="添加教案"/>
            ...
            <div id="dlg" class="easyui-dialog" style="padding:10px 20px"
                ...
                <form id="fileUpload" method="post" action="" enctype="multipart/form-data">
                    ...
                    标题：
                    <input class="easyui-textbox" type="text" required="true"
                           style="height: 30px; width: 500px; margin-left: 20px;" name="teachingPlan.pieceName"/>
                    <br/>
                    <br/>
                    简介：
                    <input class="easyui-textbox" type="text" required="true"
                           style="height: 30px; width: 500px; margin-left: 20px;" name="teachingPlan.chapterName"/>
                    <br/>
                    <br/>
                    附件：
                    <!-- <input class="choose" name="downLoad.filePath"/> -->
                    <input class="easyui-filebox" id="file" name="file" required="true" buttonText="选择文件"
                           style="width:500px; height: 26px">
                    <br/>
                    <hr/>
                    <input type="button"" class="btn btn-default" style="margin-right:20px;" onclick="upload()" value="上
                    传" />
                </form>
