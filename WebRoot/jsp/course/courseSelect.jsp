                ...
                <table border="0">
                    <tr>
                        ...
                        <td><input name="course.studentId" class="easyui-textbox" readonly="readonly"
                                   style="height: 30px; width: 200px; " value="${session.user.userId}"/></td>
                    </tr>
                    <tr>
                        <td>班级：</td>
                    ...
                    <tr>
                        <td>Email：</td>
                        <td><input name="course.email" class="easyui-textbox"
                                   data-options="required:true,validType:'email'" style="height: 30px; width: 200px; "/>
                        </td>
                    </tr>
                    <tr>
                        <td>手机号：</td>
                        <td><input name="course.telno" class="easyui-textbox" style="height: 30px; width: 200px;"
                                   data-option="required:true,validTpye:'number'"/></td>
                    </tr>
                    <tr>
                        <td>学年：</td>
                        <td><input name="course.syear" class="easyui-textbox"
                                   data-options="required:true,validType:'number'" style="height: 30px; width: 200px;"/>
                        </td>
                    </tr>
                </table>
