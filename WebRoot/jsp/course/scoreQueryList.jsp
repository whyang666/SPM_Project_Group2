    ...
    <form id="fileUpload" method="post" enctype="multipart/form-data">
        <table style="border-collapse:collapse ;" width="600px" height="50px" cellspacing="5" cellpadding="5">
            <tr>
                ...
                <td width="200px" align="left"><input class="easyui-filebox" id="file" name="file" buttonText="选择文件"
                                                      accept=".xlsx,.xls" style="width:300px; height: 26px"></td>
                <td width="100px" align="left"><a href="javascript:void(0)" class="easyui-linkbutton"
                                                  onclick="uploadFile()" style="width: 100px">上 传</a></td>
            </tr>
        </table>
    </form>
</div>
<div id="dlg-buttons" align="center">
    <a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-cancel"
       onclick="javascript:$('#dlg').dialog('close')" style="width:90px">关 闭</a>
</div>

<c:if test="${session.user.position=='2' }">
    <form id="ff" method="post">
        <table style="background:#efefef; border-collapse:collapse ;" width="100%" height="50px" cellspacing="5"
               cellpadding="5">
            <tr>
        ...
        <div style="text-align:center;padding:5px">
            ...
            <c:if test="${session.user.position!='3' }">
                <input type="button" class="btn btn-default" style="margin-right:20px;" onclick="uploadScore()"
                       value="成绩上传"/>
            </c:if>
        </div>
    ...
    <div id="toolbar">
        <c:if test="${session.user.position!='3' }">
            <a href="javascript:void(0)" class="easyui-linkbutton" iconCls="icon-redo" plain="true"
               onclick="sendEmail(1)">群发邮件通知成绩</a>
        </c:if>
    </div>
</div>
