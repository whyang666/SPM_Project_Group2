...
<div style="margin-top:20px;margin-right:20px;margin-left:20px;margin-bottom:50px; ">
    ...
    <div align="center" style="margin-top:25px; "><a href="javascript:void(0)" class="easyui-linkbutton c6"
                                                     iconCls="icon-ok" onclick="javaScript:$('#win').window('close');"
                                                     style="width:90px">关闭</a></div>
</div>
</body>
